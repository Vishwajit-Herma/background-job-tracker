...
This project is licensed under the MIT License — see the [LICENSE](https://github.com/Vishwajit-Herma/background-job-tracker/blob/main/sdk/LICENSE) file for details.
